    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-cream-100">
        <div className="text-center">
          ...
          <p className="mt-6 text-primary-700 font-medium text-lg">Loading NexMart...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-cream-50">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <h1 className="font-display text-6xl lg:text-8xl text-primary-800 leading-[0.9] tracking-tight">
                    Nex<span className="text-accent-600">Mart</span>
                  </h1>
              ...
              <div className="relative">
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-large">
                  <img
                    ...
                    alt="NexMart Curated Collection"
      ...
      <section className="py-16 px-4 lg:px-8 max-w-7xl mx-auto">
        ...
        {featuredProducts.length > 0 ? (
                ...
                >
                  ...
                  <div className="p-6 space-y-3">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      >
                        <button
                          className={`px-4 py-2 rounded-lg font-semibold transition-colors ${product.in_stock
          ...
          <div className="text-center py-20 bg-white rounded-2xl shadow-soft">
            ...
            <p className="text-primary-600 text-xl mb-6">New treasures coming soon to NexMart</p>
            <Link
              to="/products"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              <img
                ...
                alt="Artisan crafting at NexMart"
      ...
      <section className="py-16 px-4 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <div className="w-32 h-1 bg-accent-500 mx-auto mb-6"></div>
          <p className="text-xl text-primary-600 max-w-3xl mx-auto font-body leading-relaxed">
            Meet the talented creators behind NexMart's botanical treasures - independent artisans who craft with passion and purpose
          </p>
        </div>
        ...
        {featuredVendors.length > 0 ? (
          ...
          <div className="text-center py-20 bg-white rounded-2xl shadow-soft">
            ...
            <p className="text-primary-600 text-xl mb-6">Amazing artisans joining NexMart soon</p>
            <Link
              to="/vendors"
              className="inline-block text-accent-600 hover:text-accent-700 font-medium transition-colors"
            >
