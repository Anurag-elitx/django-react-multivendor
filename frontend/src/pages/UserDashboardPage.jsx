    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-cream-50 to-primary-50 flex items-center justify-center">
        <div className="max-w-md mx-auto text-center bg-white rounded-3xl shadow-xl p-8">
          ...
          <h2 className="text-2xl font-bold text-primary-800 mb-4">Welcome to NexMart</h2>
              ...
              {user.is_vendor && (
                <div className="bg-gradient-to-br from-purple-50 to-accent-50 rounded-2xl p-6 border-2 border-purple-200 lg:max-w-sm">
                  ...
                  <p className="text-purple-700 mb-4 text-sm leading-relaxed">
                    Access your vendor tools to manage products, view analytics, and grow your business on NexMart.
                  </p>
                  <Link
                    to="/vendor/dashboard"
            ...
            <nav className="flex space-x-1">
              {[
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center space-x-2 px-4 py-3 rounded-xl font-medium transition-all duration-300 ${activeTab === tab.id
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {addressesLoading ? (
                  ...
                  addresses.map((address) => (
                    <div
                      key={address.id}
                      className={`bg-gradient-to-br rounded-2xl p-6 border-2 transition-all duration-300 ${address.is_default
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        <div className="flex items-center space-x-2">
                          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${address.address_type === 'shipping'
