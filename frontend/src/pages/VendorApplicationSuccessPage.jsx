      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white rounded-2xl shadow-soft p-12">
          ...
          <p className="text-neutral-600 text-lg mb-8 leading-relaxed">
            Thank you for your interest in becoming a NexMart vendor. We've received your application
          ...
          <div className="mt-8 pt-8 border-t border-cream-200">
            <p className="text-neutral-500 text-sm">
              ...
              <a href="mailto:vendors@nexmart.com" className="text-primary-600 hover:underline">
                vendors@nexmart.com
              </a>
            </p>
          </div>
